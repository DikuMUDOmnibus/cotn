...
// Cotn
DECLARE_DO_FUN(do_zombieforsake);
DECLARE_DO_FUN(do_maxgnosis);
DECLARE_DO_FUN(do_xcenter);
...
DECLARE_DO_FUN(do_gale);
DECLARE_DO_FUN(do_damn);
DECLARE_DO_FUN(do_favorclear);
...
DECLARE_DO_FUN( do_apsleep);
DECLARE_DO_FUN( do_dirtkick);
DECLARE_DO_FUN( do_grapple);
DECLARE_DO_FUN( do_flamestrike);
DECLARE_DO_FUN( do_detectliving);
DECLARE_DO_FUN( do_battlerage);
DECLARE_DO_FUN( do_shadowtravel);
