...
/*Thief Commands*/
        ...
        { "smokescreen",     do_smokescreen, POS_DEAD,                 3,  LOG_NORMAL, 0,0,0 },
...
// Xrakisis
    { "mercy",           do_mercy,        POS_DEAD,                 3,  LOG_ALWAYS, 0,0,0 },
    ...
    { "rompractice",       do_rompractice, POS_DEAD,                 3,  LOG_NORMAL, 0,0,0 },
    ...
    { "kshow",     do_kshow, POS_DEAD,                 3,  LOG_NORMAL, 0,0,0 },
    { "damnation",     do_damn, POS_DEAD,                 3,  LOG_NORMAL, CLASS_DEMON,0,0 },
    { "xcenter",     do_xcenter, POS_DEAD,                 3,  LOG_NORMAL, 0,0,0 },
    { "maxgnosis",     do_maxgnosis, POS_DEAD,                 3,  LOG_NORMAL, CLASS_WEREWOLF,0,0 },
...
// Drexx
  ...
  */
    ...
    { "gale",     do_gale, POS_DEAD,                 3,  LOG_NORMAL, CLASS_ELEMENTAL,0,0 },
...
// had to put it after shappie breath
  ...
  */
    ...
    { "layonhands",    do_layonhands, POS_DEAD,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
    ...
    { "entangle",      do_web,   POS_DEAD,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
    { "dirtkick",      do_dirtkick,   POS_DEAD,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
    { "detectliving",      do_detectliving,   POS_STANDING,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
    { "flamestrike",      do_flamestrike,   POS_DEAD,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
    { "grapple",      do_grapple,   POS_DEAD,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
    ...
    { "shadowtravel",      do_travel,   POS_STANDING,   3, LOG_NORMAL, CLASS_ANTIPALADIN,0,0},
...
//	{ "setshin",	do_shinflag,	POS_STANDING,   12,	LOG_NORMAL,	0,0,0},
	...
	{ "zombieforsake",	do_zombieforsake,	POS_FIGHTING, 3, LOG_NORMAL, CLASS_ZOMBIE, 0, 0},
...
// Lvl 4 - curse ---
        {"vtwist", do_vtwist, POS_STANDING, 3, LOG_NORMAL, 4, DISC_VAMP_DAIM,
         5},
        {"wither", do_wither, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF, DISC_WERE_HAWK,
         7},
...
// Chimerstry
        ...
        {"train", do_train, POS_FIGHTING, 1, LOG_NORMAL, 0, 0, 0},
...
/* need it before forge */
        ...
        {"research", do_research, POS_FIGHTING, 3, LOG_NORMAL, 0, 0, 0},
 ...
 */
// Ahroun
        {"razorclaws", do_razorclaws, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_WOLF, 4},

// Homid
//  Persuasion, automatic
        {"staredown", do_staredown, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_OWL, 5},
        {"disquiet", do_disquiet, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_OWL, 6},
        {"reshape", do_reshape, POS_STANDING, 3, LOG_NORMAL, CLASS_WEREWOLF, DISC_WERE_OWL,
         7},
        {"cocoon", do_cocoon, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF, DISC_WERE_OWL,
         8},
...
// Metis
        ...
        {"burrow", do_burrow, POS_FIGHTING, 3, LOG_NORMAL, 3, DISC_WERE_HAWK,
         6},
        {"nightsight", do_nightsight, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_HAWK, 1},
         ...
         * Luna Powers 
         */
        {"flameclaws", do_flameclaws, POS_STANDING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_LUNA, 1},
        {"motherstouch", do_motherstouch, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_LUNA, 3},
        {"gmotherstouch", do_gmotherstouch, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_LUNA, 4},
        {"sclaws", do_sclaws, POS_STANDING, 3, LOG_NORMAL, CLASS_WEREWOLF, DISC_WERE_LUNA,
         5},
        {"moonbeam", do_moonbeam, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_LUNA, 8},
        //{ "moonarmour",   do_moonarmour,POS_STANDING,    3,  LOG_NORMAL, 4,DISC_WERE_LUNA,2 },
        {"moongate", do_moongate, POS_STANDING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_LUNA, 6},
        /*
         * No more luna Powers 
         */

        {"tribe", do_tribe, POS_STANDING, 3, LOG_NORMAL, CLASS_WEREWOLF, 0, 0},
...
/* vamp protean healing*/
        ...
        {"shadowplane", do_shadowplane, POS_STANDING, 3, LOG_NORMAL, 8,
         DISC_VAMP_OBTE, 3},
        {"shadowplane", do_shadowplane, POS_STANDING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_OWL, 3},
        {"shadowsight", do_shadowsight, POS_SITTING, 3, LOG_NORMAL, 8,
         DISC_VAMP_OBTE, 2},
        {"shadowsight", do_shadowsight, POS_SITTING, 3, LOG_NORMAL, CLASS_WEREWOLF,
         DISC_WERE_HAWK, 2},
        ...
        {"vanish", do_vanish, POS_STANDING, 3, LOG_NORMAL, 3, DISC_WERE_OWL,
         1},
        {"web", do_web, POS_FIGHTING, 3, LOG_NORMAL, CLASS_WEREWOLF, DISC_WERE_SPID, 2},
...
/* Tag commands */
    ...
    { "favorclear",     do_favorclear, POS_DEAD,                 3,  LOG_NORMAL, 0,0,0 },
