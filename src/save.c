...
void fwrite_char(CHAR_DATA * ch, FILE * fp)
{
	...
	fprintf(fp, "PcPractice   %d\n", ch->pcpractice);
        ...
        fprintf(fp, "PlayerPotentia   %d\n",   ch->pPotentia               );
	fprintf(fp, "Bladeexp	  %d\n", ch->bladeexp);
...
void fread_char(CHAR_DATA * ch, FILE * fp)
{
        ...
        for (;;)
        {
			...
			KEY("Bladeexp", ch->bladeexp, fread_number(fp));
                ...
                case 'C':
		        KEY("Chakra", ch->chakra, fread_number( fp ) );
			...
			KEY("KingRank", ch->pcdata->kingrank, fread_number(fp));
		        ...
		        KEY("PlayerPotentia",ch->pPotentia, fread_number( fp ) );
