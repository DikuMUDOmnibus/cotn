...
void do_maxgnosis (CHAR_DATA *ch, char *arg)
{
if (IS_NPC(ch)) return;
...
if (ch->bones < 1000)
{
stc("It costs 1000 Bones to utilize this power, and you dont have it!\n\r",ch);
return;
}

ch->gnosis[GCURRENT] = 20;
ch->gnosis[GMAXIMUM] = 20;
ch->pcdata->quest -= 5000;
send_to_char("Your gnosis is now maxxed.\n\r",ch);
return;
